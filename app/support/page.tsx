            ...
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="rounded-2xl border border-blue-100 bg-blue-50 px-4 py-3 text-sm text-blue-800">
                  <span className="font-semibold">Looking for a refund?</span> You can request one yourself from{" "}
                  <a href="/manage-subscription" className="font-medium underline">Billing</a> — we&apos;ll check your eligibility (30-day money-back on eligible purchases). Or send a message below and we&apos;ll help.
                </div>
